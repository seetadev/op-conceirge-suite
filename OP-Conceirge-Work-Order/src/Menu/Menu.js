...
class Menu extends Component {
  ...
  render() {
    return (
      <div className="Menu">
        <button onClick={() => this.doSave()}> Save On-chain on OP </button>
        <button onClick={() => this.doSaveAs()}> Connect to Pyth </button>
        <button onClick={() => this.doPrint()}> WorldID Verify </button>
